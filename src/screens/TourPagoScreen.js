...
export default function TourPagoScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.purchaseDetails}>
        <Text style={styles.sectionTitle}>Resumen del Tour</Text>
        <Text style={styles.detailText}>Tour: Pasantía Awajún</Text>
        <Text style={styles.detailText}>Fecha Seleccionada: 08/12/24</Text>
        <Text style={styles.detailText}>Cantidad de Personas: 2</Text>
        <Text style={styles.detailText}>Precio Unitario: S/ 120.00</Text>
        <Text style={styles.totalText}>Total: S/ 240.00</Text>
      </View>
